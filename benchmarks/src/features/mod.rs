...
use io::{
    ...
    read_stereo_perception_records_by_suffix, round_trip_molfiles, sdf_parse_records_json,
    sdf_record_json, small_record, smarts_query_records_json, substructure_record_json,
    zero_coordinate_model,
};
...
pub(crate) use io::read_smiles_records;
#[cfg(test)]
pub(crate) use io::{IndexedSmallRecord, IndexedSmilesRecord};
#[cfg(test)]
...
pub(crate) fn evaluate(
    ...
    match benchmark {
        ...
        "io.sdf.v2000.parse" => Ok(json!({ "records": sdf_parse_records_json(fixture_path)? })),
        "io.sdf.v2000.write" => {
